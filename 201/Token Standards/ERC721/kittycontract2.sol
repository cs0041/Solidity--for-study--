...
// - getAllCatsFor(view function) is constant time
// - transfer is linear gas and time cause we loop array in function _removeTokenIdFromOwner 
//   it very bad cause it not view function we will paying for gas is more expensive than KittycontractV1 it bad improvement
